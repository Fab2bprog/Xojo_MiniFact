#tag Class
Protected Class Class_ContactFourn
	#tag Method, Flags = &h0
	...
	#tag Method, Flags = &h0
		Sub DBase_Create(numcli as Integer)
		  ...
		  DBaseRSTemp = DBaseID.SQLSelect("SELECT IFNULL(MAX(NUMCONTACT)+1,1) AS MAXNUM FROM "+TableContact+" WHERE NUMFOURN="+str(numcli))
		  ...
		  OrdreSql=" INSERT INTO [TABLECONTACT](NUMFOURN  ,  "+_
		  "                            NUMCONTACT       ,  "+_
		  "                            NOM              ,  "+_
		  "                            FONCTION         ,  "+_
		  "                            EMAIL            ,  "+_
		  ...
		  OrdreSql=ReplaceAll(OrdreSql,"[NUMFOURN]"   ,str(numcli)    )
	...
	#tag Method, Flags = &h21
		Private Sub DBase_MajRecordset()
		  ...
		  DBaseRS.Field("NUMFOURN").Value    = NumFourn
	...
	#tag Method, Flags = &h21
		Private Sub MajPropriete()
		  ...
		  NumFourn          = DBaseRS.Field("NUMFOURN").Value
	...
	#tag Property, Flags = &h0
		TableContact As String = "CONTACTFOURN"
	#tag EndProperty
